...
class UpcomingMapperKtTest : TestCase() {
    ...
    fun testMapRemoteMovieToUpcomingMovie_allValid() {
        val entity = mapRemoteMovieToUpcomingMovie(remoteMovie = movieResponse)
    ...
    fun testMapRemoteMovieToUpcomingMovie_ImageSelection_useImage() {
        ...
        val entity = mapRemoteMovieToUpcomingMovie(remoteMovie = expectedMovie)
        reusableTests(entity)
    ...
    private fun reusableTests(actual: UpcomingMovieEntity) {
